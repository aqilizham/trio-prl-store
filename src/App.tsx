  ...
  return (
    <div className="site-shell">
      ...
      <header className="site-header">
        ...
        <a className="wordmark" href="#top" aria-label="trioPRL home"><span className="wordmark-mark">tr</span><span><strong>trioPRL</strong><small>CLASSIC GOODS</small></span></a>
      ...
      <main id="top">
        <section className="hero-section"><div className="hero-copy"><p className="eyebrow">The classic edit · 2026</p><h1>Good clothes,<br /><em>properly made.</em></h1><p className="hero-description">A considered wardrobe of timeless shirts, knits and polos. Familiar silhouettes, better fabrics and an easy sense of occasion.</p><a className="dark-button" href="#shop">Explore the collection <ArrowDown size={17} /></a><p className="hero-note"><span className="note-line" /> Free delivery on orders over RM250</p></div><div className="hero-visual"><div className="hero-image-wrap"><img src={products[0].image} alt="Model wearing a relaxed ivory oxford shirt" /></div><div className="hero-caption"><span>The Everyday Oxford</span><strong>{formatPrice(189)}</strong></div><div className="hero-stamp">Dress<br /><i>well.</i></div></div></section>
        ...
        <section id="about" className="studio-section"><div className="studio-image"><img src={products[2].image} alt="Navy knitwear and cream tee arranged on a table" /><span>Material study no. 04</span></div><div className="studio-copy"><p className="eyebrow">Our point of view</p><h2>Wear it in,<br /><em>wear it out.</em></h2><p>trioPRL is a study in enduring menswear: dependable staples, classic proportions and pieces that carry a little more character every time they are worn.</p><a className="underlined-link" href="#journal">Read our journal <ArrowRight size={16} /></a><div className="studio-signature">trio<br /><i>PRL</i></div></div></section>

...
function App() {
  ...
  return (
    <div className="site-shell">
      ...
      <main id="top">
        <section className="hero-section"><div className="hero-copy"><p className="eyebrow">The classic edit · 2026</p><h1>Good clothes,<br /><em>properly made.</em></h1><p className="hero-description">A considered wardrobe of timeless shirts, knits and polos. Familiar silhouettes, better fabrics and an easy sense of occasion.</p><a className="dark-button" href="#shop">Explore the collection <ArrowDown size={17} /></a><p className="hero-note"><span className="note-line" /> Free delivery on orders over RM250</p></div><div className="hero-visual"><div className="hero-image-wrap"><img src={products[0].image} alt="Navy classic button-down shirt" decoding="async" /></div><div className="hero-caption"><span>The Classic Oxford</span><strong>{formatPrice(189)}</strong></div><div className="hero-stamp">Dress<br /><i>well.</i></div></div></section>

...
export const products: Product[] = [
  ...
  { id: 'mesh-01', name: 'Polo Mesh Tee', price: 159, category: 'tees', tone: 'Deep navy · piqué cotton', image: asset('trio-knitwear-source.jpg'), label: 'New in', description: 'A crisp polo silhouette with understated contrast detailing and a clean, relaxed drape.', sizes: ['S', 'M', 'L', 'XL'] },
  { id: 'halfzip-01', name: 'Halfzipper Harbour', price: 229, category: 'knitwear', tone: 'Heather grey · cotton fleece', image: asset('trio-knit-source.jpg'), label: 'Limited run', description: 'A weighty quarter-zip for cool mornings, long drives and slow weekends.', sizes: ['S', 'M', 'L', 'XL'] },
  { id: 'tee-01', name: 'Round Neck Tee', price: 99, category: 'tees', tone: 'Black · 240gsm cotton', image: asset('trio-knitwear-source.jpg'), imagePosition: '50% 48%', description: 'The dependable tee, cut from substantial cotton and finished with a neat chest pocket.', sizes: ['S', 'M', 'L', 'XL'] },
